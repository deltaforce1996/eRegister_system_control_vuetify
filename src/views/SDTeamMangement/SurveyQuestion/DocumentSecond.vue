    ...
    <v-row align="center" justify="center">
      ...
      <v-col cols="auto" class="d-flex align-center mt-5">
        <v-radio-group v-model="prefixName" inline >
          <v-radio label="นาย" value="นาย" class="text-white text-subtitle-1"></v-radio>
          <v-radio label="นาง" value="นาง" class="text-white text-subtitle-1"></v-radio>
          <v-radio label="นางสาว" value="นางสาว" class="text-white text-subtitle-1"></v-radio>
        </v-radio-group>
      </v-col>
      <v-col cols="auto" class="d-flex align-center mt-5">
        <v-text-field
      ...
      <v-col cols="auto" class="d-flex align-center">
        <b class="text-white text-subtitle-1">รับทราบและจะดำเนินการตามที่ระบุ</b>
      </v-col>
    </v-row>
    <v-row align="center" justify="center">
      <v-col cols="auto" class="d-flex align-center">
        <v-btn class="text-capitalize"
               @click="handleConfirm"
               rounded style="background-color: #ed1c24;"
               height="35">
