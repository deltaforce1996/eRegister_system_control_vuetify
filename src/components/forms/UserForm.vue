      ...
      <v-card class="elevation-1">
        <v-card-text>
          <v-row no-gutters dense>
            ...
            <v-col cols="12">
              <v-text-field v-model="item_input.email"
                    variant="outlined"
                    placeholder="Email"
          ...
          <v-row no-gutters dense>
            ...
            <v-col cols="12">
              <v-select v-model="item_input.companyId"
                  variant="outlined"
                  density="compact"
          ...
          <v-row no-gutters dense>
            ...
            <v-col cols="12">
              <v-select v-model="item_input.roleId"
                variant="outlined"
                density="compact"
                placeholder="Role"
          ...
          <v-row no-gutters dense>
            ...
            <v-col cols="12">
              <v-select v-if="selected_items.teamComp.length > 0"
                variant="outlined"
                density="compact"
                placeholder="Team"
...
const handleCreatedTeam = async () => {
  try {
    ...
    const response = await teamService.createdTeam(p_companyId, p_nameTH, p_nameEN);
    if (response.data?.is_success) {
...
const  handleCreated = async ()=>{
  try {
    ...
    const response = await userService.createdUser(v_Email, v_MemberTypeId, v_RoleId, v_TeamId);
    if (response) {
      handleDismissEvent()
    }
    } catch (e) {
