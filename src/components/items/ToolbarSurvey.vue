...
<template>
  <v-row class="elevation-3 mt-5" style="background-color: white;">
    ...
    <v-col v-if="step === step1.No"  cols="3" align="center" class="pa-3  progress_bar">
      <div>
    ...
    <v-col v-if="step === step2.No"  cols="3" align="center" class="pa-3  progress_bar">
      <div>
    ...
    <v-col v-if="step === step3.No"  cols="3" align="center" class="pa-3  progress_bar">
      <div>
    ...
    <v-col v-if="step === step4.No"  cols="3" align="center" class="pa-3  progress_bar">
      <div>
